...
public enum ErrorResponseCode implements BaseResponseCode {
    ...
    INVALID_HTTP_MESSAGE_PARAMETER("GLOBAL_400_2",BAD_REQUEST,"HTTP 요청 파라미터 형식이 잘못되었습니다."),
    ACCESS_DENIED_REQUEST("GLOBAL_403",FORBIDDEN,"해당 요청에 접근 권한이 없습니다."),
    NOT_FOUND_ENDPOINT("GLOBAL_404",NOT_FOUND,"존재하지 않는 앤드포인트 입니다. 요청 URL을 확인해주세요,."),
